	...
	return (
		<Container display="Grid">
			...
			<Divider variant="middle" orientation='horizontal' style={{ paddingBottom:'10px'}}/>
						...
						<Typography style={{backgroundColor:'#fff4e5',color:'#663C01', fontFamily: 'Cairo', paddingBottom: '20px', paddingTop: '60px', fontWeight:'500' , fontSize:'23px',padding:'15px' }} variant="h5">
