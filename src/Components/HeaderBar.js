		...
		<Container className={classes.AppBarContainer}>
			<AppBar elevation={3} className={classes.AppBar} variant="elevation" anchor={getLanguage() === 'ar' ? 'right' : 'left'}>
				<Toolbar>
					...
					<Container>
						<Typography variant="subtitle1">{t('- Within every governorate, there is one or more courts of appeal.')}</Typography>
						<Typography variant="subtitle1">{t('- The Court of Appeal consists of 3 judges: a president and two consultants.')}</Typography>
